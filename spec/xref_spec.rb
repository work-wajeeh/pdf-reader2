...
class Pdf::Reader2::XRef
  attr_reader :xref
end

describe Pdf::Reader2::XRef do
  describe "initilisation" do
    context "with cairo-basic.pdf" do
      context "as a File" do
        it "loads all xrefs correctly" do
          ...
          tbl      = Pdf::Reader2::XRef.new(filename)
    ...
    context "with cross_ref_stream.pdf" do
      ...
      subject     { Pdf::Reader2::XRef.new(file)}
      ...
      it "loads type 2 objects references" do
        expect(subject.xref[281][0]).to eql(Pdf::Reader2::Reference.new(341,0))
      end
    end
    ...
    context "with cross_ref_stream.pdf" do
      ...
      it "raises an error when attempting to load an invalid xref stream" do
        ...
        end.to raise_exception(Pdf::Reader2::MalformedPdfError)
      end
    end
