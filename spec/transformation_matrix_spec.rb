...
describe Pdf::Reader2::TransformationMatrix do
  describe "#multiply!" do
    ...
    context "with [2,3,0   4,5,0   6 7 1]" do
      let(:matrix_one) { Pdf::Reader2::TransformationMatrix.new(2,3,4,5,6,7)}

      context "and the identity matrix" do
        let(:matrix_two) { Pdf::Reader2::TransformationMatrix.new(1,0,0,1,0,0)}
      ...
      context "and a horizontal displacement" do
        let(:matrix_two) { Pdf::Reader2::TransformationMatrix.new(1,0, 0,1, 10,0)}
      ...
      context "and applying a vertical displacement" do
        let(:matrix_two) { Pdf::Reader2::TransformationMatrix.new(1,0, 0,1, 0,10)}
      ...
      context "and applying a horizontal and vertical displacement" do
        let(:matrix_two) { Pdf::Reader2::TransformationMatrix.new(1,0, 0,1, 10,10)}
      ...
      context "and applying a horizontal scale" do
        let(:matrix_two) { Pdf::Reader2::TransformationMatrix.new(10,0, 0,1, 0,0)}
      ...
      context "and applying a vertical scale" do
        let(:matrix_two) { Pdf::Reader2::TransformationMatrix.new(1,0, 0,10, 0,0)}
      ...
      context "and applying a horizontal and vertical scale" do
        let(:matrix_two) { Pdf::Reader2::TransformationMatrix.new(10,0, 0,10, 0,0)}
      ...
      context "and applying a 30 degree rotation" do
        let(:matrix_two) {
          Pdf::Reader2::TransformationMatrix.new(
