...
describe PDF::Reader2::PageState do
  ...
  describe "#DEFAULT_GRAPHICS_STATE" do
    subject { PDF::Reader2::PageState::DEFAULT_GRAPHICS_STATE }

    context "when walking more than one page" do
      let!(:expected) { PDF::Reader2::PageState::DEFAULT_GRAPHICS_STATE.dup }

      before do
        2.times do
          state = PDF::Reader2::PageState.new(page)
  ...
  describe "#save_graphics_state" do
    context "with an empty page" do
      let!(:state)  {PDF::Reader2::PageState.new(page) }
